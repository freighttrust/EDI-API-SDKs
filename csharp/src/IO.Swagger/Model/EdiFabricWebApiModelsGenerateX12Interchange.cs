...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdiFabricWebApiModelsGenerateX12Interchange :  IEquatable<EdiFabricWebApiModelsGenerateX12Interchange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdiFabricWebApiModelsGenerateX12Interchange" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as EdiFabricWebApiModelsGenerateX12Interchange);
        }

        /// <summary>
        /// Returns true if EdiFabricWebApiModelsGenerateX12Interchange instances are equal
        /// </summary>
        /// <param name="input">Instance of EdiFabricWebApiModelsGenerateX12Interchange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdiFabricWebApiModelsGenerateX12Interchange input)
        {
            if (input == null)
                return false;
